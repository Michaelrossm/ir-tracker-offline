...
$csv = Join-Path $releaseDirectory "soak-test-1.0.1-beta.2-72h.csv"
$stdout = Join-Path $releaseDirectory "soak-test-1.0.1-beta.2-72h.stdout.log"
$stderr = Join-Path $releaseDirectory "soak-test-1.0.1-beta.2-72h.stderr.log"
