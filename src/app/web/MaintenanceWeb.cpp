...
void handleMaintenancePage() {
  ...
  body += F(
      ...
      "Die Weboberfläche ist im Update enthalten. History und Einstellungen bleiben erhalten.</p>"
      ...
      "ausschließlich vollständige, passend signierte IRUP-Pakete mit Firmware und Weboberfläche; ein Downgrade ist gesperrt.</p>"
